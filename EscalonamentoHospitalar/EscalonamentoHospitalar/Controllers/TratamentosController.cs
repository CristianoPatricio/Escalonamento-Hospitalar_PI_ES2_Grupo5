...
namespace EscalonamentoHospitalar.Controllers
{
    public class TratamentosController : Controller
    {
        ...
        {
            var hospitalDbContext = _context.Tratamento.Include(t => t.Grau).Include(t => t.Patologia);
        ...
        public async Task<IActionResult> Create([Bind("TratamentoId,PatologiaId,GrauId,DataInicio,DataFim,DuracaoCiclo,Regime,Decorrer,Concluido")] Tratamento tratamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TratamentoId,PatologiaId,GrauId,DataInicio,DataFim,DuracaoCiclo,Regime,Decorrer,Concluido")] Tratamento tratamento)
        {
